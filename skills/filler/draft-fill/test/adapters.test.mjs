...
assert.equal(wechatChannelsTopicEvidenceOk({ matched_tag_count: 0, plain_text_matched_tag_count: 2, all_plain_tags_matched: true }, ["带鱼", "量价"]), false);
assert.equal(wechatChannelsTopicEvidenceOk({ matched_tag_count: 2, token_count: 2, all_tags_matched: true }, ["带鱼", "量价"]), true);
